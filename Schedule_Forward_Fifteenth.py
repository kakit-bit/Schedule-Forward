...
if __name__ == '__main__':
    ...
    # Pre-Determined Line Number Fifteen of SMH Haematology Lab
    fifteenth_line = [
        None, None, "E", "E", "E", "E", "E",  # Week 1
        "E", "E", None, None, "E", "E", "E",
        None, None, "E", "E", "E", "E", "E",
        None, None, "E", "E", "E", "E", "E",
        None, None, "E", "E", "E", "E", "E",
    ...
    result = {i : fifteenth_line[(counter+new_year_index) % len(fifteenth_line)] for counter, i in enumerate(this_year)}
